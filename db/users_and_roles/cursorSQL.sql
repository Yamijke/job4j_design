...
-- перемещаем курсор на 20 позицию
move forward 20 from cp;

-- перемещаем курсор на 15 позицию
move backward 5 from cp;

-- перемещаем курсор на 7 позицию
move backward 8 from cp;

-- перемещаем курсор на 2 позицию
move backward 5 from cp;

-- перемещаем курсор на 1 позицию
move backward 1 from cp;
